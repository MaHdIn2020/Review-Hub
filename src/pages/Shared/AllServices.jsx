...
const AllServices = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 sm:mb-10">All Services</h1>
          ...
          {services.length > 0 ? (
            services.map((service) => (
              <div key={service._id} className="card shadow-md rounded-xl p-4 border">
                ...
                />
                <h2 className="text-lg sm:text-xl font-bold text-blue-700">{service.title}</h2>
