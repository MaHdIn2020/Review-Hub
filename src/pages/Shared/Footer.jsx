      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-gray-700">
        ...
        <div>
          <div className="flex items-center gap-2 text-primary mb-4">
            <span className="text-2xl font-extrabold">ReviewHub</span>
          </div>
          <p className="text-sm leading-relaxed">
            Your trusted platform for honest service reviews and ratings.<br />
        ...
        <nav aria-label="Quick Links">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/all-services" className="link link-hover">All Services</a>
            </li>
            <li>
              <a href="/addservice" className="link link-hover">Add Service</a>
            </li>
            <li>
              <a href="/my-reviews" className="link link-hover">My Reviews</a>
            </li>
          </ul>
        </nav>
